...
& $publisher -AssemblyPath $built -Destination $destination -AdapterId 'HorticultureNovelSeeds' `
    ...
    -RequiredPackageIds @('lan.horticulture.novelseeds') -NoMapCommands @('HNS_ADAPTER_STATUS') `
    ...
    -ExpensiveCommands @('HNS_BALANCE_TEST','HNS_MASK_REGRESSIONS','HNS_EXPORT_MASK_DIAGNOSTIC', `
