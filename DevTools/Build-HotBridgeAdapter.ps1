...
& $publisher -AssemblyPath $built -Destination $destination -AdapterId 'HorticultureNovelSeeds' `
    ...
    -RequiredPackageIds @('lan.horticulture.novelseeds') -NoMapCommands @('HNS_ADAPTER_STATUS','HNS_CROSS_REGRESSIONS','HNS_TRAIT_CATALOG_REGRESSIONS','HNS_BREEDING_MIX_DIAGNOSTIC') `
    ...
    -ExpensiveCommands @('HNS_BALANCE_TEST','HNS_MASK_REGRESSIONS','HNS_CROSS_REGRESSIONS','HNS_TRAIT_CATALOG_REGRESSIONS','HNS_BREEDING_MIX_DIAGNOSTIC','HNS_RESOURCE_JOB_REGRESSION','HNS_RESOURCE_JOB_STATUS','HNS_RESOURCE_JOB_INTERRUPT','HNS_RESOURCE_JOB_RETRY','HNS_RESOURCE_JOB_CLEANUP','HNS_EXPORT_MASK_DIAGNOSTIC', `
