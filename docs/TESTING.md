...
For a focused scenario, use one of `startup`, `ordinary-crop`, `sowable-tree`, `cross-pollination`, `produce-processing`, `knowledge`, `save-reload`, `negative`, or `long-running`:
